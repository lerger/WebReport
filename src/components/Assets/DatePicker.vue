...
window.datePicker = (function() {
    ...
    MobileCalendar.prototype = {
        init: function(params) {
            ...
            console.log(document.getElementById("calendar").innerHTML);
            // console.log(this.trigger.getAttribute("innerHTML"));
            ...
            if (params.minDate) {
                ...
                this.minM = ~~minArr[1];
                this.minD = ~~minArr[2];
                console.log('起始时间是',params.minDate.split('-'));
            };
            if (params.maxDate) {
                ...
                this.maxM = ~~maxArr[1];
                this.maxD = ~~maxArr[2];
                console.log('截止时间是',params.maxDate.split('-'));
            };
        ...
        bindEvent: function(type) {
            ...
            function dateCtrlInit() {
                console.log('初始化年月日插件默认值');
                var date = new Date();
                var yesterday_milliseconds = date.getTime() - 1000*60*60*24;
                date.setTime(yesterday_milliseconds);
                console.log('初始化年月日',date);
                var dateArr = {
                    yy: date.getYear(),
                    mm: date.getMonth(),
                    dd: date.getDate() - 1
                ...
                console.log(dateArr.yy,dateArr.mm,dateArr.dd);
                setDateGearTooth();
            }
            //呼出年月插件
            function popupYM(e) {
            ...
            function finishMobileDate(e) {
                ...
                console.log('当前选取日期',currentSelectDate);
